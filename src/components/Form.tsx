...
const Form: FunctionComponent<FormProps> = () => {
    ...
    return ( 
        <div className="flex grow bg-white p-5">
            ...
            <div className="flex flex-col w-[274px] h-[568px] p-5 bg-sidebar-desktop rounded-xl">
            ...
            <form action="" className="flex grow flex-col px-24">
                ...
                { step === 1 && <div className="flex flex-col">
                    ...
                    <input type="text" id="name" placeholder="e.g. Stephen King" className="border-brand-light-gray text-brand-marine-blue focus:ring-brand-purplish-blue focus:border-brand-purplish-blue font-medium placeholder:opacity-70 rounded-lg py-3 px-4" />
                    
                    <label htmlFor="email" className=" mt-5 mb-2">Email Address</label>
                    <input type="email" id="email" placeholder="e.g. stephenking@lorem.com" className="border-brand-light-gray text-brand-marine-blue font-medium placeholder:opacity-70 rounded-lg py-3 px-4" />

                    <label htmlFor="phone" className=" mt-5 mb-2">Phone Number</label>
                    <input type="tel" id="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" placeholder="e.g. +1 234 567 890" className="border-brand-light-gray text-brand-marine-blue font-medium placeholder:opacity-70 rounded-lg py-3 px-4" />
