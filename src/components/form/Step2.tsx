  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-3 grid-rows-1 gap-5">
        <button
          type="button"
          className={`flex h-52 flex-col justify-between rounded-xl p-5 ring-1 hover:ring-brand-purplish-blue focus:outline-none focus:outline-brand-purplish-blue ${
            errors.plan
